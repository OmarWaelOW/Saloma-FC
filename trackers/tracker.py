...
class Tracker:
    ...
    def detect_frames(self, frames):
        batch_size = 10  # Reduce batch size for better performance
        detections = []
        for i in range(0, len(frames), batch_size):
            detections_batch = self.model.predict(frames[i:i+batch_size], conf=0.25)  # Increase confidence threshold
